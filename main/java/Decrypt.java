                        ...
                        if(uid==user_id){
                            ...
                            while(rs.next()){       
                                ...
                                if(file_key.equals(ip_file_key)){
                                   ...
                                   // File dec_file = new File("C:/Users/Sanavi/Desktop/OOP-Harsh/File-encrypt-decrypt-JAVA/Enc-Dec-Files/" + ip_file_id + ".decrypted");
                                   File dec_file = new File(System.getProperty("user.home") + "/Downloads/"+ ip_file_id + ".decrypted");
